 ...
 */
public interface tempDepartmentService {
	/**
	 * 用户列表
	 */
    ...
    JSONObject getAllDepartmentsArch(JSONObject jsonObject);

	JSONObject getDepartmentPerson(JSONObject requestJson);
}
