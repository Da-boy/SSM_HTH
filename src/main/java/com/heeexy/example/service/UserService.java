...
public interface UserService {
	 ...
	 * 用户列表
	 */
	JSONObject listUserBySearch(JSONObject jsonObject);
    ...
    JSONObject getAllProjects(JSONObject request2Json);

	JSONObject getAllProjectsByPerson(JSONObject jsonObject);
}
