...
import com.heeexy.example.dao.tempPositionDao;
import com.heeexy.example.service.tempDepartmentService;
import com.heeexy.example.service.tempPositionService;
 ...
 */
@Service
public class TempPositionServiceImplTemp implements tempPositionService {
	@Autowired
	private UserDao userDao;
	@Autowired
	private tempDepartmentDao tempDepartmentDao;
	@Autowired
	private tempPositionDao positionDao;
	...
	public JSONObject getAllPositions() {
		List<JSONObject> positions = positionDao.getAllPositions();
		return CommonUtil.successPage(positions);
	}
