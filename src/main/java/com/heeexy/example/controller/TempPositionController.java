...
public class TempPositionController {
	@Autowired
	private UserService userService;
	@Autowired
	private tempDepartmentService tempDepartmentService;
	@Autowired
	private tempPositionService positionService;
	...
	@RequiresPermissions(value = {"position:add", "position:update"}, logical = Logical.OR)
