...
public interface UserDao {
    ...
    int countUserBySearch(JSONObject jsonObject);

	List<JSONObject> listUserBySearch(JSONObject jsonObject);

    List<JSONObject> getAllProjects(JSONObject jsonObject);

	List<JSONObject> getAllProjectsByPerson(JSONObject jsonObject);

	List<JSONObject> getUserByusernameAndEmail(JSONObject jsonObject);
}
