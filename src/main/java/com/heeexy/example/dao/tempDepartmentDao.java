 ...
 */
public interface tempDepartmentDao {
	/**
	 * 查询用户数量
	 */
	 ...
	 * 在添加/修改用户的时候要使用此方法
	 */
	List<JSONObject> getAllDepartments();
    ...
    JSONObject getJLDeptById(JSONObject jsonObject);

	List<JSONObject> getDeptByUserId(JSONObject jsonObject);

	List<JSONObject> getPersonsByDeptId(JSONObject tempJs);
}
